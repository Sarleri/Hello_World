...
public partial class Coles : System.Web.UI.Page
{
    ...
    {
        GetruntimestatColes();
        getpendingreportColes();
    }
    protected void GetruntimestatColes(){
     ...
     protected void getpendingreportColes(){
    ...
    private void DocumentCompletedruntime(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgRTColes.Visible = true;
                imgRTColes.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
          private void DocumentCompletedpending(object sender, WebBrowserDocumentCompletedEventArgs e)
    {
        ...
        using (Bitmap bitmap = new Bitmap(browser.Width, browser.Height))
        {
            ...
            using (MemoryStream stream = new MemoryStream())
            {
                ...
                imgPCColes.Visible = true;
                imgPCColes.ImageUrl = "data:image/png;base64," + Convert.ToBase64String(bytes);
            }
        }
    }
